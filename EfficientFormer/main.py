...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='efficientformerv2_s2', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data-path', default='./imagenet', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='ExDark-COCO', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'ExDark-COCO'],
...
def main(args):
    ...
    device = torch.device(args.device, 1)
